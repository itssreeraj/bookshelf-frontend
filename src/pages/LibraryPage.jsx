...
export default function LibraryPage() {
  ...
  const [filters, setFilters] = useState({ title: '', genre: '', language: '', author: '', publisher: '' });
  ...
  }, [token, filters.title, filters.genre, filters.language, filters.author, filters.publisher]);
